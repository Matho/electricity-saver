...
class EventLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_log" do
    assert_difference("EventLog.count") do
      post event_logs_url, params: { event_log: { endpoint_device_id: @event_log.endpoint_device_id, event_date: @event_log.event_date, title: @event_log.title } }
    end
  ...
  test "should update event_log" do
    patch event_log_url(@event_log), params: { event_log: { endpoint_device_id: @event_log.endpoint_device_id, event_date: @event_log.event_date, title: @event_log.title } }
