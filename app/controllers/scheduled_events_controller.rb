  ...
  def create
    ...
    respond_to do |format|
      if @scheduled_event.save
        format.html { redirect_to scheduled_event_url(@scheduled_event), notice: "Scheduled event was successfully created." }
  ...
  def update
    respond_to do |format|
      if @scheduled_event.update(scheduled_event_params)
        format.html { redirect_to scheduled_event_url(@scheduled_event), notice: "Scheduled event was successfully updated." }
