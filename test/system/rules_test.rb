...
class RulesTest < ApplicationSystemTestCase
  ...
  test "should create rule" do
    ...
    fill_in "Action", with: @rule.action
    fill_in "Cron friday", with: @rule.cron_friday
    fill_in "Cron monday", with: @rule.cron_monday
    fill_in "Cron thursday", with: @rule.cron_thursday
    fill_in "Cron tuesday", with: @rule.cron_tuesday
    fill_in "Cron wednesday", with: @rule.cron_wednesday
    fill_in "Rule", with: @rule.rule
    fill_in "Smart plug device", with: @rule.smart_plug_device_id
