...
class NetworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create network" do
    assert_difference("Network.count") do
      post networks_url, params: { network: { active: @network.active, description: @network.description, title: @network.title } }
    end
  ...
  test "should update network" do
    patch network_url(@network), params: { network: { active: @network.active, description: @network.description, title: @network.title } }
